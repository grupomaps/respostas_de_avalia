...
import { Plus, Edit2, Trash2, CheckCircle, XCircle, AlertCircle, Link2, Unlink } from 'lucide-react';
...
export function Empresas() {
  ...
  // 1. Definir os parâmetros do Google
  ...
  // 2. Redirecionar o usuário para o Google
              ...
              {empresas.length === 0 ? (
                ...
                empresas.map((empresa) => (
                  <tr key={empresa.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-slate-600">{empresa.email_responsavel}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
